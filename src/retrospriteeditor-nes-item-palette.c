/* retrospriteeditor-nes-item-palette.c
 *
 * Copyright 2023 vi
 *
...
struct _RetrospriteeditorNesItemPalette
{
...
G_DEFINE_FINAL_TYPE (RetrospriteeditorNesItemPalette, retrospriteeditor_nes_item_palette, GTK_TYPE_BOX)

static void
retrospriteeditor_nes_item_palette_class_init (RetrospriteeditorNesItemPaletteClass *klass)
{
  GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);
}

static void
retrospriteeditor_nes_item_palette_init (RetrospriteeditorNesItemPalette *self)
{
...
GtkWidget *
item_nes_palette_get_radio (RetrospriteeditorNesItemPalette *self)
{
  return self->radio_btn;
}

guint32 *
item_nes_palette_get_colour (RetrospriteeditorNesItemPalette *self)
{
  return self->colour;
}

guint32 *
item_nes_palette_get_colour_index (RetrospriteeditorNesItemPalette *self)
{
  return self->index_color;
}
