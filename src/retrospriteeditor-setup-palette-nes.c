/* retrospriteeditor-setup-palette-nes.c
 *
 * Copyright 2023 vi
 *
...
struct _RetrospriteeditorSetupPaletteNes
{
...
G_DEFINE_FINAL_TYPE (RetrospriteeditorSetupPaletteNes, retrospriteeditor_setup_palette_nes, GTK_TYPE_WINDOW)

static void
retrospriteeditor_setup_palette_nes_class_init (RetrospriteeditorSetupPaletteNesClass *klass)
{
...
static void
retrospriteeditor_setup_palette_nes_init (RetrospriteeditorSetupPaletteNes *self)
{
